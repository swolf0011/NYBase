package com.swolf.libraryviewlistview.osRefreshListView;
...
import com.swolf.libraryviewlistview.R;
...
public class NYOSRefreshListView extends ListView implements OnScrollListener {
    ...
    private void init() {
        setCacheColorHint(context.getColor(android.R.color.transparent));
