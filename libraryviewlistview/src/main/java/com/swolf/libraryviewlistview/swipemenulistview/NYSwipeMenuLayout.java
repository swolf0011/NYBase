 ...
 */
public class NYSwipeMenuLayout extends FrameLayout {
    ...
    private NYSwipeMenuView mMenuView;
    private int mDownX;
    ...
    public NYSwipeMenuLayout(View contentView, NYSwipeMenuView menuView) {
    ...
    private NYSwipeMenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    private NYSwipeMenuLayout(Context context) {
        super(context);
    }
    ...
    public NYSwipeMenuView getMenuView() {
        return mMenuView;
    }
