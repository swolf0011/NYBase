 ...
 */
public class NYCamera2ImageConstant {
    ...
    public static Size chooseOptimalSize(Size[] choices, int textureViewWidth, int textureViewHeight, int maxWidth, int maxHeight, Size aspectRatio) {
        ...
        if (bigEnough.size() > 0) {
            return Collections.min(bigEnough, new NYCompareSizesByArea());
        } else if (notBigEnough.size() > 0) {
            return Collections.max(notBigEnough, new NYCompareSizesByArea());
        } else {
            return choices[0];
        }
    }
