...
public class NYVideoRecorder {
     ...
     * 默认值录像
     *
     * @param filePath      定义输出文件
     * @param audio_source  设置录音源为MIC
     * @param output_format 定义输出格式
     * @param audio_encoder 定义音频编码
     * @param video_source  摄像头为视频源
     * @param video_encoder 定义视频编码
     * @param width         定义视频宽
     * @param height        定义视频高
     * @param rate          每秒多少帧
     * @param sv            定义视频显示
