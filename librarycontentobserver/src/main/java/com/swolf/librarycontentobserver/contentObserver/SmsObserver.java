package com.swolf.librarycontentobserver.contentObserver;
...
public class SmsObserver extends ContentObserver {
    ...
    public static void registerSmsObserver(Context context, SmsObserver smsObserver) {
        context.getContentResolver().registerContentObserver(Uri.parse("content://sms"), true, smsObserver);
    }

    public static void unregisterSmsObserver(Context context, SmsObserver smsObserver) {
