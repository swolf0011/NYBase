 ...
 */
public class NYStatusBarCompat {
     ...
     */
    public static void setStatusBarColor(Activity activity, String statusColorStr) {
        int statusColor = Color.parseColor(statusColorStr);
