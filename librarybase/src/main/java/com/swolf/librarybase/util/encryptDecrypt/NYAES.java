...
public class NYAES {
    ...
    public static void main(String[] arg) {
        ...
        System.out.println("AES ECB encoded with Base64: " + NYBase64Util.encode(encodedText));
        ...
        System.out.println("AES CBC encoded with Base64: " + NYBase64Util.encode(encodedText));
